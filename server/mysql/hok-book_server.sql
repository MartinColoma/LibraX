...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2025 at 03:45 PM
...
--
CREATE DATABASE
IF NOT EXISTS `hok-book_server` DEFAULT CHARACTER
SET utf8mb4
...
`isbn`,
`title
`, `subtitle`, `description`, `publisher`, `publication_year`, `edition`, `category_id`, `language`, `date_added`) VALUES
(1, '9780553386790', 'Dune', 'The Epic Science Fiction Classic', 'A science fiction saga on desert planet Arrakis.', 'Ace', '1965', '1st Edition', 1, 'English', '2025-08-01 21:27:28'),
(2, '9781451648539', 'Steve Jobs', NULL, 'The biography of Steve Jobs by Walter Isaacson.', 'Simon & Schuster', '2011', '1st Edition', 2, 'English', '2025-08-01 21:27:28');
...
(255) DEFAULT NULL,
  `status` enum
('available','borrowed','reserved','lost','maintenance') DEFAULT 'available',
  `date_acquired` date DEFAULT curdate
(),
  `book_condition` enum
('New','Good','Fair','Damaged','Lost') DEFAULT 'Good'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
copy_id`,
`book_id
`, `barcode`, `location`, `status`, `date_acquired`, `book_condition`) VALUES
(1, 1, 'BC-DUNE-001', 'Shelf A1', 'available', '2025-08-01', 'Good'),
(2, 1, 'BC-DUNE-002', 'Shelf A1', 'borrowed', '2025-08-01', 'Good'),
(3, 2, 'BC-JOBS-001', 'Shelf B2', 'available', '2025-08-01', 'New');
...
(255) NOT NULL,
  ...
  `category_type` enum
('Fiction','Non-Fiction','Special') NOT NULL,
...
category_id`,
`category_name
`, `category_description`, `category_type`, `created_at`, `updated_at`) VALUES
...
(11) NOT NULL,
  `action` enum
('added','borrowed','returned','lost','maintenance') NOT NULL,
...
log_id`,
`copy_id
`, `action`, `action_date`, `notes`) VALUES
(1, 1, 'added', '2025-08-01 21:30:33', 'Initial stock of Dune copy 1.'),
(2, 2, 'added', '2025-08-01 21:30:33', 'Initial stock of Dune copy 2.'),
(3, 2, 'borrowed', '2025-08-01 21:30:33', 'Borrowed by John Doe'),
(4, 3, 'added', '2025-08-01 21:30:33', 'Initial stock of Steve Jobs biography.');
...
--
ALTER TABLE `books`
ADD CONSTRAINT `books_ibfk_1` FOREIGN KEY
...
--
ALTER TABLE `book_authors`
ADD CONSTRAINT `book_authors_ibfk_1` FOREIGN KEY
(`book_id`) REFERENCES `books`
(`book_id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `book_authors_ibfk_2` FOREIGN KEY
...
--
ALTER TABLE `book_copies`
ADD CONSTRAINT `book_copies_ibfk_1` FOREIGN KEY
(`book_id`) REFERENCES `books`
(`book_id`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `inventory_logs`
ADD CONSTRAINT `inventory_logs_ibfk_1` FOREIGN KEY
(`copy_id`) REFERENCES `book_copies`
(`copy_id`) ON
DELETE CASCADE ON
UPDATE CASCADE;
COMMIT;
